...
/**
 * Tool to watch for class unloading events.
 */
public class ClassUnloadWatchTool implements ToolHandler {
    ...
    public ToolDefinition getDefinition() {
        ...
        return new ToolDefinition(
            "class_unload_watch",
            "Watch for class unloading events. Returns a watch ID. Use events_pending to retrieve captured events.",
            schema
        );
    }
    ...
    public ToolResult execute(McpRequest request) {
        ...
        try {
            ...
            String watchId = EventMonitorManager.getInstance().watchClassUnload(vm, classFilter);

            StringBuilder sb = new StringBuilder();
            sb.append("Class unload watch created.\n");
            ...
            return ToolResult.error("Failed to create class unload watch: " + e.getMessage());
        }
    }
}
