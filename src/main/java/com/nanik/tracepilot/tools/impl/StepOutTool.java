...
/**
 * Tool to step out of the current method.
 */
public class StepOutTool implements ToolHandler {
    ...
    public ToolDefinition getDefinition() {
        ...
        return new ToolDefinition(
            "step_out",
            "Step out of current method (run until return). IMPORTANT: Call wait_for_stop after this. Thread must be suspended.",
            schema
        );
    }
    ...
    public ToolResult execute(McpRequest request) {
        ...
        try {
            ...
            return ToolResult.success("Step out initiated on thread: " + thread.name() +
